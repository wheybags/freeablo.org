...
Plugin URI: http://wordpress.org/plugins/wordquest/
...
function add_experience() {
    ...
    if( ( $_POST['post_status'] == 'publish' ) && ( $_POST['original_post_status'] != 'publish' ) ) {
        ...
        $exp = str_word_count($_POST['content']) + $experience; #going off of word count instead of characters
...
function idle_messages(){
    $file = plugins_url()."/wordquest/idle.rpg"; 
