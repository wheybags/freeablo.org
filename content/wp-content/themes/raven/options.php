...
function optionsframework_options() {
	...
	// Test data
	$magpro_slider_start = array("false" => __("No", 'raven' ),"true" => __("Yes", 'raven' ));
	$homecat_array = array("hori" => __("Horizontal Layout", 'raven' ),"verti" => __("Vertical Layout", 'raven' ));
	...
	$options_pages[''] = __("Select a page:", 'raven' );
	...
	$options[] = array( "name" => "country1",
		...
		$options[] = array( "name" => __("Select a Skin", 'raven' ),
							"type" => "groupcontaineropen");	

				$options[] = array( "name" => __("Select a Skin", 'raven' ),
										"desc" => __("Please note that default and raven skins are same if you are using raven theme. If you are using a child theme then default skin will be child theme.", 'raven' ),
										"id" => "skin_style",
										"type" => "images",
										"std" => "default",
										"options" => array(
											'raven' => $imagepath . 'raven.png',
		...
		$options[] = array( "name" => __("Logo Settings", 'raven' ),
							"type" => "groupcontaineropen");	

				$options[] = array( "name" => __("Upload Logo", 'raven' ),
									"desc" => __("Upload your logo here. max width 450px, It will replace the blog title and description.", 'raven' ),
									"id" => "header_logo",
									"type" => "proupgrade");	
		...
		$options[] = array( "name" => __("Adsense Settings", 'raven' ),
							"type" => "groupcontaineropen");	

					$options[] = array( "name" => __("Google Adsense ID", 'raven' ),
										"desc" => __("Enter your full adsense id. Ex : pub-1234567890", 'raven' ),
		...
		$options[] = array( "name" => __("Single Page Settings", 'raven' ),
							"type" => "groupcontaineropen");
							
					$options[] = array( "name" => __("Show Featured Image?", 'raven' ),
										"desc" => __("Select yes if you want to show featured image as header.", 'raven' ),
					...
					$options[] = array( "name" => __("Show Ratings?", 'raven' ),
										"desc" => __("Select yes if you want to show ratings under post title.", 'raven' ),
					...
					$options[] = array( "name" => __("Show Posted by and Date?", 'raven' ),
										"desc" => __("Select yes if you want to show Posted by and Date under post title.", 'raven' ),
					...
					$options[] = array( "name" => __("Show Categories and Tags?", 'raven' ),
										"desc" => __("Select yes if you want to show categories under post title.", 'raven' ),
					...
					$options[] = array( "name" => __("Show Social Share Buttons?", 'raven' ),
										"desc" => __("Select yes if you want to show social buttons under post title.", 'raven' ),
										"id" => "show_socialbuts_on_single",
										"std" => "true",
										"type" => "proupgrade",
										"options" => $magpro_slider_start);																	

					$options[] = array( "name" => __("Show Author Bio", 'raven' ),
										"desc" => __("Select yes if you want to show Author Bio Box on single post page.", 'raven' ),
										"id" => "show_author_bio",
										"std" => "true",
										"type" => "select",
										"class" => "mini", //mini, tiny, small
					...
					$options[] = array( "name" => __("Show RSS Box", 'raven' ),
										"desc" => __("Select yes if you want to show RSS box on single post page.", 'raven' ),
										"id" => "show_rss_box",
										"std" => "true",
										"type" => "select",
										"class" => "mini", //mini, tiny, small
					...
					$options[] = array( "name" => __("Show Next/Previous Box", 'raven' ),
										"desc" => __("Select yes if you want to show Next/Previous box on single post page.", 'raven' ),
										"id" => "show_np_box",
										"std" => "true",
										"type" => "select",
										"class" => "mini", //mini, tiny, small
					...
					$options[] = array( "name" => __("Show Related Posts Box", 'raven' ),
										"desc" => __("Select yes if you want to show Next/Previous box on single post page.", 'raven' ),
										"id" => "show_related_box",
										"std" => "true",
										"type" => "proupgrade",
	...
	$options[] = array( "name" => "country2",
		...
		$options[] = array( "name" => __("Social Settings", 'raven' ),
							"type" => "groupcontaineropen");	

					$options[] = array( "name" => __("Twitter", 'raven' ),
										"desc" => __("Enter your twitter id. Do not enter the twitter url, Enter only the id.", 'raven' ),
										"id" => "twitter_id",
										"std" => "",
										"type" => "text");

					$options[] = array( "name" => __("Redditt", 'raven' ),
										"desc" => __("Enter your reddit url", 'raven' ),
										"id" => "redit_id",
										"std" => "",
										"type" => "text");

					$options[] = array( "name" => __("Delicious", 'raven' ),
										"desc" => __("Enter your delicious url", 'raven' ),
										"id" => "delicious_id",
										"std" => "",
										"type" => "text");

					$options[] = array( "name" => __("Technorati", 'raven' ),
										"desc" => __("Enter your technorati url", 'raven' ),
										"id" => "technorati_id",
										"std" => "",
										"type" => "text");

					$options[] = array( "name" => __("Facebook", 'raven' ),
										"desc" => __("Enter your facebook url", 'raven' ),
										"id" => "facebook_id",
										"std" => "",
										"type" => "text");

					$options[] = array( "name" => __("Stumble", 'raven' ),
										"desc" => __("Enter your stumbleupon url", 'raven' ),
										"id" => "stumble_id",
										"std" => "",
										"type" => "text");

					$options[] = array( "name" => __("Youtube", 'raven' ),
										"desc" => __("Enter your youtube url", 'raven' ),
										"id" => "youtube_id",
										"std" => "",
										"type" => "text");

					$options[] = array( "name" => __("Flickr", 'raven' ),
										"desc" => __("Enter your flickr url", 'raven' ),
										"id" => "flickr_id",
										"std" => "",
										"type" => "text");

					$options[] = array( "name" => __("LinkedIn", 'raven' ),
										"desc" => __("Enter your linkedin url", 'raven' ),
										"id" => "linkedin_id",
										"std" => "",
										"type" => "text");

					$options[] = array( "name" => __("Google", 'raven' ),
										"desc" => __("Enter your google url", 'raven' ),
										"id" => "google_id",
										"std" => "",
										"type" => "text");
	...
	$options[] = array( "name" => "country3",
		...
		$options[] = array( "name" => __("Slider Settings", 'raven' ),
							"type" => "groupcontaineropen");	

					$options[] = array( "name" => __("Select Category", 'raven' ),
										"desc" => __("Posts from this category will be shown in the slider.", 'raven' ),
										"id" => "magpro_slidercat",
										"std" => "true",
										"type" => "select",
										"options" => $options_categories);
					
					$options[] = array( "name" => __("Show slider on homepage", 'raven' ),
										"desc" => __("Select yes if you want to show slider on homepage.", 'raven' ),
					...
					$options[] = array( "name" => __("Show slider on Single post page", 'raven' ),
										"desc" => __("Select yes if you want to show slider on Single post page.", 'raven' ),
					...
					$options[] = array( "name" => __("Show slider on Pages", 'raven' ),
										"desc" => __("Select yes if you want to show slider on Pages.", 'raven' ),
					...
					$options[] = array( "name" => __("Show slider on Category Pages", 'raven' ),
										"desc" => __("Select yes if you want to show slider on Category Pages.", 'raven' ),
					...
					$options[] = array( "name" => __("How many slides?", 'raven' ),
										"desc" => __("Enter a number. Ex: 5 or 7", 'raven' ),
										"id" => "magpro_slidernumposts",
										"std" => "5",
										"class" => "mini",
										"type" => "text");										

					$options[] = array( "name" => __("Select slider or header", 'raven' ),
										"desc" => __("Select wilto if you want to use slider else select custom header.", 'raven' ),
		...
		$options[] = array( "name" => __("Sliders Available in PRO Version", 'raven' ),
							"type" => "groupcontaineropen");	

					$options[] = array( "name" => __("Upgrade now for these Sliders", 'raven' ),
										"desc" => __("Available in PRO", 'raven' ),
	...
	$options[] = array( "name" => "country4",
		...
		$options[] = array( "name" => __("Layout Settings", 'raven' ),
							"type" => "groupcontaineropen");	

					$options[] = array( "name" => __("Select a homepage layout", 'raven' ),
										"desc" => __("Images for layout.", 'raven' ),
										"id" => "homepage_layout",
										"std" => "magten",
										"type" => "images",
										"options" => array(
											'magten' => $imagepath . 'magelvn.png',
		...
		$options[] = array( "name" => __("Layouts Available in PRO", 'raven' ),
							"type" => "groupcontaineropen");	

					$options[] = array( "name" => __("Upgrade now for these layouts.", 'raven' ),
										"desc" => __("UpGrade Now.", 'raven' ),
	...
	$options[] = array( "name" => "country19",
		...
		$options[] = array( "name" => __("MagEleven Settings", 'raven' ),
							"type" => "tabheading");
		
		
		$options[] = array( "name" => __("Recent Posts Settings", 'raven' ),
							"type" => "groupcontaineropen");	

					$options[] = array( "name" => __("Show posted by and on?", 'raven' ),
										"desc" => __("Select yes if you want to show posted by and on", 'raven' ),
		...
		$options[] = array( "name" => __("Category Box Settings", 'raven' ),
							"type" => "groupcontaineropen");	

					$options[] = array( "name" => __("Select a category for 1st box.", 'raven' ),
										"desc" => __("Two posts from this category will show up in category box.", 'raven' ),
										"id" => "magelvn_cat_1",
										"std" => "Choose a category",
										"type" => "select",
										"options" => $options_categories);
										
					$options[] = array( "name" => __("Select a category for 2nd box.", 'raven' ),
										"desc" => __("Two posts from this category will show up in category box.", 'raven' ),
										"id" => "magelvn_cat_2",
										"std" => "Choose a category",
										"type" => "select",
					...
					$options[] = array( "name" => __("Select a category for 3rd box.", 'raven' ),
										"desc" => __("Two posts from this category will show up in category box.", 'raven' ),
										"id" => "magelvn_cat_3",
										"std" => "Choose a category",
										"type" => "select",
	...
	$options[] = array( "name" => "country9",
		...
		$options[] = array( "name" => __("Standard Blog Settings", 'raven' ),
							"type" => "groupcontaineropen");	

					$options[] = array( "name" => __("Show Ratings?", 'raven' ),
										"desc" => __("Select yes if you want to show ratings", 'raven' ),
					...
					$options[] = array( "name" => __("Show Categories/Tags?", 'raven' ),
										"desc" => __("Select yes if you want to show categories and tags in posts", 'raven' ),
	...
	$options[] = array( "name" => "country5",
		...
		$options[] = array( "name" => __("Sidebar Settings", 'raven' ),
							"type" => "tabheading");
			
		
		$options[] = array( "name" => __("Sidebar Ad Settings", 'raven' ),
							"type" => "groupcontaineropen");	

					$options[] = array( "name" => __("Show 300x250 ads in sidebar?", 'raven' ),
										"desc" => __("Select yes if you want to show 300x250 ads in sidebar. If you select yes, go to widgets page and drag/drop the ads", 'raven' ),
										"id" => "show_sidebar_ads",
										"std" => "true",
										"type" => "select",
										"class" => "mini", //mini, tiny, small
					...
					$options[] = array( "name" => __("Show 125x125 ads in sidebar?", 'raven' ),
										"desc" => __("Select yes if you want to show 125x125 ads in sidebar. If you select yes, go to widgets page and drag/drop the ads", 'raven' ),
