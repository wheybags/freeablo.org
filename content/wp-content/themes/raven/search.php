			<?php get_header(); ?>
                    ...
                    <div id="inner_content_section">
                        ...
                        <div id="main_content_section_search_title"> 
                        		...
                        		<h2 class="main_content_section_search_title"><?php _e('Search Results for : ', 'raven') ?><?php echo get_search_query(); ?></h2>
                        ...
                        <div id="main_content_section_search">
                                   ...
                                   <?php if (have_posts()) : ?>
									<?php $count = 0; while (have_posts()) : the_post(); $count++; ?>									
										<div <?php post_class('mag_post1') ?> id="post-<?php the_ID(); ?>">
											...
											<div class="mag_post_excerpt">
												...
												<?php 
													$magthumb = wp_get_attachment_image_src( get_post_thumbnail_id($post->ID), 'raventhumb', false, '' ); 
												?>
                                                <div class="mag_post_excerpt_img">
												<img src="<?php echo $magthumb[0]; ?>" alt="<?php echo raven_get_limited_string(get_the_title(), 40, '...') ?>" />
												</div>
												<?php endif; ?>
                                                
                                                <div class="mag_post_excerpt_p">
													<p><?php echo raven_get_limited_string(get_the_excerpt(), 150, '...') ?></p>
                                                    <p class="mag_post_excerpt_more"><a href="<?php the_permalink(); ?>" title="<?php printf( esc_attr__( 'Permalink to %s', 'raven' ), the_title_attribute( 'echo=0' ) ); ?>" rel="bookmark">Read More</a></p>                                                
                                                </div>
									...
									<?php endwhile; ?>
												...
												<?php else : ?>
													<div class="nopost">
														<p><?php _e('Sorry, No Results Found.', 'raven') ?></p>
													 </div><!-- /nopost -->
												<?php endif; ?>
